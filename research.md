---
title: "Fu Lab - Research"
layout: textlay
excerpt: "Fu Lab -- Research"
sitemap: false
permalink: /research/
---
...
![]({{ site.url }}{{ site.baseurl }}/images/respic/Movie_with_masks_mag.mp4){: style="width: 30%; float: center; margin: 0px"}
![]({{ site.url }}{{ site.baseurl }}/images/respic/PSF.jpg){: style="width: 30%; float: center; margin: 0px"}
![]({{ site.url }}{{ site.baseurl }}/images/respic/Summary.jpg){: style="width: 30%; float: center; margin: 0px"}