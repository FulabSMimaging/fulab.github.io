...
![]({{ site.url }}{{ site.baseurl }}/images/respic/PSF.jpg){: style="width: 10%; float: center; margin: 0px"}
![]({{ site.url }}{{ site.baseurl }}/images/respic/Summary.jpg){: style="width: 30%; float: right; margin: 0px"}